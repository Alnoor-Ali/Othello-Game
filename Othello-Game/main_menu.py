...
def main_menu():
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("assets/Play Rect.png"), pos=(510, 250), 
                            text_input="AI", font=get_font(50), base_color="#d7fcd4", hovering_color="#32f35f")
        OPTIONS_BUTTON = Button(image=pygame.image.load("assets/Options Rect.png"), pos=(510, 370), 
                            text_input="AI-Pruning", font=get_font(50), base_color="#d7fcd4", hovering_color="#32f35f")
        OPTIONS_BUTTON2 = Button(image=pygame.image.load("assets/Play Rect.png"), pos=(510, 490), 
                            text_input="PVP", font=get_font(50), base_color="#d7fcd4", hovering_color="#32f35f")
